...
class _HashTagTextFieldState extends State<HashTagTextField> with RestorationMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  bool get _hasIntrinsicError =>
      widget.maxLength != null && widget.maxLength! > 0 && _effectiveController.value.text.characters.length > widget.maxLength!;
  ...
  Widget build(BuildContext context) {
    ...
    assert(
      !(widget.basicStyle != null &&
          ...
          (widget.basicStyle!.fontSize == null || widget.basicStyle!.textBaseline == null)),
